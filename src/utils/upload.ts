...
export async function uploadFile(file: File): Promise<any> {
  ...
  return await service.post('/api/public/upload', formData, config).catch((e) => {
...
// export async function uploadFile(file: File): Promise<any> {
//   const resp = await service.get(`https://api-company.lingman.tech/api/storage/minio?type=it-admin&filename=${file.name}`) as string
//   await fetch(resp, {
//     method: 'PUT',
//     body: file,
//   })
